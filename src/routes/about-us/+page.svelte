...
<main>
  <section class="evidence-container">
    <div class="evidence-container-content-wrapper">
      <Title headingText="What we provide..." className="evidence-container-title" />
      <p class="evidence-container-paragraph">
        Our platform provides a safe and secure way to collect and store your evidence, keeping you
        in control and protected at all times.
      </p>
    ...
    <div class="evidence-card-container">
      <InformationCard
        Icon={CardIconImg}
        labels={["Jpeg", "Webp"]}
        cardTitle="Images"
        cardSubText="Save videos in MP4 format or capture them instantly using your device’s camera. Easily add recordings from your gallery or shoot new ones on the spot to document events clearly and efficiently."
      />
      <InformationCard
        Icon={CardIconVideo}
        labels={["MP4", "MP3"]}
      ...
      />
      <InformationCard
        Icon={CardIconLocation}
        labels={["Google Maps", "GPS"]}
        cardTitle="Location"
        cardSubText="Save videos in MP4 format or capture them instantly using your device’s camera. Easily add recordings from your gallery or shoot new ones on the spot to document events clearly and efficiently."
      />
      <InformationCard
        ...
        cardTitle="Chat logs"
        cardSubText="Save videos in MP4 format orera. Easily add  or shoot new ones on the spot to document events clearly and efficiently."
      />
    </div>
  </section>
  ...
  <section class="reviews-container">
    <div class="reviews-container-content-wrapper">
      <Title headingText="Real people. Real results" className="review-container-title" />
      <p class="reviews-container-paragraph">
        Honest stories from real people who have experienced unfavorable working conditions in their
        own jobs—now receiving compensation because they were able to gather all the evidence
...
<style>
  ...
  .evidence-container-content-wrapper {
    display: flex;
    flex-direction: column;
    gap: var(--spacing-lg);
  ...
  .reviews-container-content-wrapper {
    display: flex;
    flex-direction: column;
    gap: var(--spacing-lg);
